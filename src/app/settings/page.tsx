      ...
      <aside className="w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 overflow-y-auto py-4">
          <ul className="space-y-1 px-3">
            <li><Link href="/" className="flex items-center px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800">Tổng quan</Link></li>
            <li><Link href="/products" className="flex items-center px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800">Sản phẩm</Link></li>
            <li><Link href="/orders" className="flex items-center px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800">Đơn hàng</Link></li>
            <li><Link href="/users" className="flex items-center px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800">Người dùng</Link></li>
            <li><Link href="/settings" className="flex items-center px-3 py-2 rounded-lg bg-blue-600 text-white">Cài đặt</Link></li>
          </ul>
        </nav>
      </aside>
